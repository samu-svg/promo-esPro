        ...
        <header className="mb-8 md:mb-10">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-orange-700 text-xl font-black text-white shadow-[0_0_20px_rgba(249,115,22,0.4)]">
                <span>P</span>
            ...
            <div className="flex items-center gap-2 self-start rounded-xl border border-orange-500/20 bg-orange-500/10 px-4 py-2 sm:self-auto">
